...
export default function Home() {
  ...
  return (
    ...
    <Head>
      <title>Play - Ascolta la tristezza</title>
    </Head>
    ...
    <main>
      ...
      <section>
        ...
        <div className={style.player + ' d-flex'}>
          ...
          <Button variant="outline-light" className={style.btn_tr + " btn-outline m-2 text-light"} href="#more">
      ...
      <section className={style.Spotify}  id="more">
        <Row className='my-5 pb-3 text-center'>
          <p className='m-0'>La tristezza viene dalla solitudine del cuore.</p>
          <p><i>Montesquieu</i></p>
        </Row>
        <Row>
          ...
          <Col md={6} className="text-center">
            <iframe className={style.plSpotify}  src="https://open.spotify.com/embed/playlist/6CWmwdX4XPWexAs8D8HmhJ?utm_source=generator" 
