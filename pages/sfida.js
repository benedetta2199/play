...
export default function Home() {
  ...
  return (
    ...
    <Head>
      <title>Play - Ascolta la sfida</title>
    </Head>
    ...
    <main>
      ...
      <section>
        ...
        <div className={style.player + ' d-flex'}>
          ...
          <Button variant="outline-light" className={style.btn_sf + " btn-outline m-2 text-light"} href="#more">
        ...
        <section className={style.Spotify}  id="more">
            ...
            <Row>
                ...
                <Col md={6} className="text-center">
                  <iframe className={style.plSpotify}  src="https://open.spotify.com/embed/playlist/1MKjci92viwng4XLceBO2J?utm_source=generator" 
