...
export default function Home() {
  ...
  return (
    ...
    <Head>
      <title>Play - Ascolta l'energia</title>
    </Head>
    ...
    <main>
      ...
      <section className={style.sectionOne}>
        ...
        <div className={style.player + ' d-flex'}>
          ...
          <Button variant="outline-light" className={style.btn_en + " btn-outline m-2 text-light"} href="#more">
        ...
        <section className={style.Spotify}  id="more">
            <Row className='my-5 pb-3 text-center'>
                <p className='m-0'>Il mondo appartiene a quelli che hanno la maggiore energia.</p>
                <p><i>Visconte Alexis de Tocqueville</i></p>
            </Row>
            <Row>
                ...
                <Col md={6} className="text-center">
                  <iframe className={style.plSpotify}  src="https://open.spotify.com/embed/playlist/6MJnS1xfiytzSZxbjwh4Xr?utm_source=generator" 
