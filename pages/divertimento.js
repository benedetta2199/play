...
export default function Home() {
  ...
  return (
    ...
    <Head>
      <title>Play - Ascolta il divertimento</title>
    </Head>
    ...
    <main>
      ...
      <section>
        ...
        <div className={style.player + ' d-flex'}>
          ...
          <Button variant="outline-light" className={style.btn_dv + " btn-outline m-2 text-light"} href="#more">
        ...
        <section className={style.Spotify}  id="more">
            <Row className='my-5 pb-3 text-center'>
                <p className='m-0'>Io penso che il divertimento sia una cosa seria.</p>
            ...
            <Row>
                ...
                <Col md={6} className="text-center">
                  <iframe className={style.plSpotify}  src="https://open.spotify.com/embed/playlist/0nWrSLh5YGnYTqCWT2BY4S?utm_source=generator" 
