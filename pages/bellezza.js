...
export default function Home() {
  ...
  return (
    ...
    <Head>
      <title>Play - Ascolta la bellezza</title>
    </Head>

    <main>
      <div className={style.divHead + " imgCredit"}>
        <img src="./emotion/bellezza.jpg" className={style.imgHead} alt=""/>
        <a href="https://www.freepik.com/free-photo/beautiful-girl-fashionable-swimsuit-isolated-gradient-neon-light_20053160.htm" className="credit">created by master1305 - www.freepik.com</a>
      </div>
      <section>
        <h1 className={style.title}>Bellezza</h1>
        <div className={style.player + ' d-flex'}>
          ...
          <Button variant="outline-light" className={style.btn_be + " btn-outline m-2 text-light"} href="#more">
        ...
        <section className={style.Spotify}  id="more">
            <Row className='my-5 pb-3 text-center'>
                <p className='m-0'>La bellezza risplende nel cuore di colui che ad essa aspira più che negli occhi di colui che la vede.</p>
            ...
            <Row>
                ...
                <Col md={6} className="text-center">
                  <iframe className={style.plSpotify}  src="https://open.spotify.com/embed/playlist/1tw3fSQdDI2cVsSTRaNWyY?utm_source=generator" 
