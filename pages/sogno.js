...
export default function Home() {
  ...
  return (
    ...
    <Head>
      <title>Play - Ascolta la sogno</title>
    </Head>

    <main>
      <div className={style.divHead + " imgCredit"}>
        <img src="./emotion/sogno.jpg" className={style.imgHead} alt=""/>
        <a href="https://www.freepik.com/free-photo/caucasian-woman-s-portrait-isolated-blue-background-multicolored-neon-light_13636129.htm" className="credit">created by master1305 - www.freepik.com</a>
      </div>
      <section className={style.sectionOne}>
        <h1 className={style.title}>Sogno</h1>
        <div className={style.player + ' d-flex'}>
          ...
          <Button variant="outline-light" className={style.btn_sg + " btn-outline m-2 text-light"} href="#more">
        ...
        <section className={style.Spotify}  id="more">
            <Row className='my-5 pb-3 text-center'>
                <p className='m-0'>Se puoi sognarlo, puoi farlo.</p>
                <p><i>Walt Disney</i></p>
            </Row>
            <Row>
                ...
                <Col md={6} className="text-center">
                  <iframe className={style.plSpotify}  src="https://open.spotify.com/embed/playlist/06JKENbVcsDWzBNocudtcd?utm_source=generator" 
